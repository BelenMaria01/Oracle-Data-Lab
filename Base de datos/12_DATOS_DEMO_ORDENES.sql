...
--
-- NOTA: en PL/SQL un SELECT no puede ir directo como argumento de una
-- llamada a función/procedimiento — solo es válido dentro de una sentencia
-- SQL (INSERT/UPDATE/SELECT). Por eso acá cada ID se resuelve primero con
-- SELECT INTO en una variable, y recién después se llama al paquete.
--------------------------------------------------------------------------------
